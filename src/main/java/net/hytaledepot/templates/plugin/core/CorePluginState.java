...
public final class CorePluginState {
  private final AtomicReference<CorePluginLifecycle> lifecycle = new AtomicReference<>(CorePluginLifecycle.NEW);
  ...
  private volatile String templateName = "Core";
  private volatile String dataDirectory = "";

  public CorePluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(CorePluginLifecycle next) {
    lifecycle.set(next);
  }
