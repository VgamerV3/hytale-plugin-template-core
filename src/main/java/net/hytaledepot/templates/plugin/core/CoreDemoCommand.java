...
public final class CoreDemoCommand extends AbstractCommand {
  private final CorePluginState state;
  private final CoreDemoService demoService;
  private final AtomicLong heartbeatTicks;

  public CoreDemoCommand(CorePluginState state, CoreDemoService demoService, AtomicLong heartbeatTicks) {
    super("hdcoredemo", "Runs a demo action for the Core template.");
